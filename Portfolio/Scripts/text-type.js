jQuery(document).ready(function(d) {
    var l = 2500
      ...
      , p = 600
      , e = 1500
      , s = (d(".cd-headline.letters").find("b").each(function() {
        var s = d(this)
          , e = s.text().split("")
    ...
    function f(s) {
        var i, e, a = w(s);
        s.parents(".cd-headline").hasClass("type") ? ((i = s.parent(".cd-words-wrapper")).addClass("selected").removeClass("waiting"),
        setTimeout(function() {
        ...
        setTimeout(function() {
            C(a, o)
        }, h)) : s.parents(".cd-headline").hasClass("letters") ? (e = s.children("i").length >= a.children("i").length,
        function s(i, e, a, n) {
            ...
            {
                var t;
                i.is(":last-child") && d("html").hasClass("no-csstransitions") && (t = w(e),
                v(e, t))
            }
        }(s.find("i").eq(0), s, e, r),
        m(a.find("i").eq(0), a, e, r)) : s.parents(".cd-headline").hasClass("clip") ? s.parents(".cd-words-wrapper").animate({
            width: "2px"
        }, p, function() {
            v(s, a),
            C(a)
    ...
    s.each(function() {
        var s, i, e, a = d(this);
        a.hasClass("loading-bar") ? (u = n,
        setTimeout(function() {
            a.find(".cd-words-wrapper").addClass("is-loading")
        }, t)) : a.hasClass("clip") ? (s = (i = a.find(".cd-words-wrapper")).width() + 10,
        i.css("width", s)) : a.hasClass("type") || (i = a.find(".cd-words-wrapper b"),
        e = 0,
        i.each(function() {
            var s = d(this).width();
            e < s && (e = s)
